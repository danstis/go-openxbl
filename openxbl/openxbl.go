...
func (c *Client) NewRequest(method, urlStr string, body interface{}) (*http.Request, error) {
	...
	req.Header.Add("X-Authorization", c.apiKey)
	if c.UserAgent != "" {
...
// Do sends an API request to the OpenXBL API and returns a response object.
...
func NewClient(apiKey string) *Client {
	...
	c.FriendsService = (*FriendsService)(&c.common)
